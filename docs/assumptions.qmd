...
| Assumption | Consequence |
|---|---|
| **Constant film coefficients** : $h_o = 13$, $h_i = 8.1$ W/(m²·K) by default (NOM-008/020-ENER values; $h_i$ is the vertical-surface value applied to all orientations) | No wind or flow-direction dependence; configurable via `config.ho`/`config.hi` |
